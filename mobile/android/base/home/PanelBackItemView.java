...
class PanelBackItemView extends LinearLayout {
    ...
    public void updateFromFilter(FilterDetail filter) {
        final String backText = TextUtils.isEmpty(filter.title)
            ? getResources().getString(R.string.home_move_up_to_root)
            : getResources().getString(R.string.home_move_up_to_filter, filter.title);
